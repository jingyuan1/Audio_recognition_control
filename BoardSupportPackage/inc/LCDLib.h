...
#define LCD_TP_EnableInterrupt (BITBAND_PERI(P4->IE,0) = 1)
#define LCD_TP_ClearInterrupt (BITBAND_PERI(P4->IFG,0) = 0)
#define LCD_TP_DisableInterrupt (BITBAND_PERI(P4->IE,0) = 0)
