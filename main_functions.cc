...
void setup() {
  ...
  //feature_provider->SetFeatureSize(kFeatureElementCount);
...
void loop() {
  ...
  TfLiteStatus process_status = recognizer->ProcessLatestResults(
      output, current_time, &found_command, &score, &is_new_command, scores, &top_index);
  ...
  RespondToCommand(error_reporter, current_time, found_command, score,
                   is_new_command, scores, top_index);
}
